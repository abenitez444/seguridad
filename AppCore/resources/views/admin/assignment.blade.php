...
@section('title')Programaciones @endsection
...
<section class="content" id="app-main">
	...
	<div class="card">
		...
		<div class="card-header">
            ...
            @if(Auth::user()->is_superadmin || Auth::user()->has_role('list_programming') || Auth::user()->has_role('edit_programming'))
			<div class="card-tools">
				<a href="{{ route('admin.assignment.create') }}"><button class="btn btn-primary mr-1 mb-1"><i class="fa fa-plus-square"></i> Agregar / Editar</button></a>
			</div>
            @endif
		</div>
		<div class="card-body">
	                    ...
	                    <template slot-scope="{ row }">
	                        <tr>
	                            ...
	                            <td class="text-right" style="width: 20%; white-space: nowrap;">
                                    ...
                                    @if(Auth::user()->is_superadmin || Auth::user()->has_role('delete_programming'))
