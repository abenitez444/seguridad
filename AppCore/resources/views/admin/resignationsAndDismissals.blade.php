...
@section('title')Renuncias y Despidos @endsection
...
<section class="content" id="app-main">
	...
	<div class="card">
		...
		<div class="card-header">
			...
			@if(Auth::user()->is_superadmin || Auth::user()->has_role('create_dismissal'))
	                    ...
	                    <template slot-scope="{ row }">
	                        <tr>
	                            ...
	                            <td class="text-right" style="width: 10%; white-space: nowrap;">
	                            	...
	                            	@if(Auth::user()->is_superadmin || Auth::user()->has_role('delete_dismissal'))
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/resignations-and-dismissals.js') }}"></script>
@endpush
