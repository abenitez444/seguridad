...
@section('title')Vigilantes @endsection
...
<section class="content" id="app-main">
	...
	<div class="card">
		...
		<div class="card-header">
			...
			@if(Auth::user()->is_superadmin || Auth::user()->has_role('create_watchmen'))
	                    ...
	                    <template slot-scope="{ row }">
	                        <tr>
	                            ...
	                            <td class="text-right" style="width: 20%; white-space: nowrap;">
	                            	@if(Auth::user()->is_superadmin || Auth::user()->has_role('edit_watchmen'))
	                                ...
	                                @endif
	                                @if(Auth::user()->is_superadmin || Auth::user()->has_role('delete_watchmen'))
	...
	<!-- /.card -->
	<!-- Modal -->
	@if(Auth::user()->is_superadmin || Auth::user()->has_role('create_watchmen') || Auth::user()->has_role('edit_watchmen'))
...
<script type="text/javascript" src="{{ asset('AppResources/plugins/v-money-master/dist/v-money.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/watchmen.js') }}"></script>
@endpush
