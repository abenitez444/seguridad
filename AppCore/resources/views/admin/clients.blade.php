...
<section class="content" id="app-main">
	...
	<div class="card">
		...
		<div class="card-header">
			...
			@if(Auth::user()->is_superadmin || Auth::user()->has_role('create_client'))
	                    ...
	                    <template slot-scope="{ row }">
	                        <tr>
	                            ...
	                            <td class="text-right" style="width: 10%; white-space: nowrap;">
	                            	@if(Auth::user()->is_superadmin || Auth::user()->has_role('edit_client'))
	                                ...
	                                @endif
	                                @if(Auth::user()->is_superadmin || Auth::user()->has_role('delete_client'))
	...
	<!-- /.card -->
	<!-- Modal -->
	@if(Auth::user()->is_superadmin || Auth::user()->has_role('create_client') || Auth::user()->has_role('edit_client'))
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/clients.js') }}"></script>
@endpush
