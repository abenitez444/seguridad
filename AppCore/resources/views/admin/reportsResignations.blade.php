...
@section('title')Reportes de Renuncias y Despidos @endsection
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/reports-resignations-and-dismissals.js') }}"></script>
@endpush
