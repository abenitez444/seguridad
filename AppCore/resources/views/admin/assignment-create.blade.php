...
@section('title')Aisgnación de Vigilantes @endsection
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-4">
                            <select class="form-control" v-on:change="changeType()" v-model="assignment.type">
                                ...
                                @if(Auth::user()->is_superadmin || Auth::user()->has_role('create_programming'))
                            	<option value="nuevo">Nueva</option>
                                @endif
                                @if(Auth::user()->is_superadmin || Auth::user()->has_role('edit_programming'))
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/assignment.js') }}"></script>
@endpush
