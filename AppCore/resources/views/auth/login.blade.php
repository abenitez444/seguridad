...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/bootstrap/dist/css/bootstrap.min.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('AppResources/fonts/font-awesome/css/font-awesome.min.css') }}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/Ionicons/css/ionicons.min.css') }}">

    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('AppResources/css/AdminLTE.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/iCheck/square/blue.css') }}">

    <!-- STYLE LOGIN -->
    <link rel="stylesheet" type="text/css" href="{{ asset('AppResources/login/css/style.css') }}">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 colbor">
                        <img class="logo-sidg" src="{{ asset('AppResources/login/img/logo-sidg.png') }}">
                    </div>
    ...
    <!-- Bootstrap 3.3.7 -->
    <script src="{{ asset('AppResources/plugins/bootstrap/dist/js/bootstrap.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('AppResources/login/js/main.js') }}"></script>
</body>
</html>
