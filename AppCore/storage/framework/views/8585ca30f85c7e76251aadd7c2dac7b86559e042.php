								...
								<div class="col-12 col-sm-7 col-md-7 col-lg-7">
									<div class="form-group">
										<div class="checkbox icheck pl-20">
											<label>
												<input type="checkbox" name="allow_comments" value="1" checked="checked" v-model="publication.allow_comment"> Permitir comentarios
											</label>
										</div>
									</div>
								</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/th3khan/Disco de respaldo/Anthony/trabajos/proyectos laravel/GestorContenido/resources/views/admin/blog/publicationEdit.blade.php ENDPATH**/ ?>