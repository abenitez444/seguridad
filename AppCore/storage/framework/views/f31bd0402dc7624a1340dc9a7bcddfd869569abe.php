                            ...
                            <div class="row">
                            					...
                            					<div class="col-12 col-sm-12 col-md-12 col-lg-12">
				                                    <div class="form-group">
				                                        ...
				                                        <div class="position-relative has-icon-left">
				                                            <input type="text" class="form-control" placeholder="Ingrese el nombre del servico a ofrecer" name="name" v-model="service.name" />
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <textarea class="form-control" placeholder="Descripción detallada del producto o servico" name="description" rows="3" v-model="service.description"></textarea>
                                            <div class="form-control-position">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="">
                                        <h4 class="card-title">Seleccione la disponibilidad del producto o servicio </h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <fieldset>
                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                <input type="checkbox" name="is_promotion" value="1" v-model="service.is_promotion">
                                                <span class="vs-checkbox">
                                                    <span class="vs-checkbox--check">
                                                        <i class="vs-icon feather icon-check"></i>
                                                    </span>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <fieldset>
                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                <input type="checkbox" name="is_principal" value="1" v-model="service.is_principal">
                                                <span class="vs-checkbox">
                                                    <span class="vs-checkbox--check">
                                                        <i class="vs-icon feather icon-check"></i>
                                                    </span>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/cooks/services.js')); ?>"></script> 
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Cabpserito/AppCore/resources/views/cooks/services.blade.php ENDPATH**/ ?>