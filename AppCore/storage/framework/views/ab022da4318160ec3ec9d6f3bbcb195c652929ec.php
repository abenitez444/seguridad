        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="header">ELEMENTOS DE PÁGINAS</li>
                    <li class="<?php echo e(request()->routeIs('hiring.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('hiring.index')); ?>">
                            <i class="fa fa-book"></i> 
                            <span>Contrataciones</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->is('admin_/page/5/element') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('element.index', '5')); ?>">
                            <i class="fa fa-th"></i> 
                            <span>Quienes Somos</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('services.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('services.index')); ?>">
                            <i class="fa fa-diamond"></i> 
                            <span>Servicios</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->is('admin_/page/7/element') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('element.index', '7')); ?>">
                            <i class="fa fa-th"></i> 
                    ...
                    <li class="header">PÁGINAS DE LA WEB</li>
                    <li class="treeview <?php echo e(request()->routeIs('page.*') ? 'active' : ''); ?>">
                        <a href="javascript:void(0)"><i class="fa fa-link"></i> <span>Páginas</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu" id="listPages">
                            <li v-for="page in pages">
                                <a :href="'<?php echo e(url('/admin_/pages/edit/')); ?>'+'/'+page.name">{{ page.name }}</a>
                            </li>
                        </ul>
                    </li>

                    <!-- <li class="header">PÁGINAS</li>
                    <li class="<?php echo e(request()->routeIs('page.edit', 'contact') ? 'active' : ''); ?>">
                    ...
                    <li class="<?php echo e(request()->routeIs('company.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('company.index')); ?>">
                            <i class="fa fa-phone"></i> 
                            <span>Información</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('logo.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('logo.index')); ?>">
...
</html><?php /**PATH /media/th3khan/Disco de respaldo/Anthony/trabajos/proyectos laravel/GestorContenido/resources/views/layouts/admin/main.blade.php ENDPATH**/ ?>