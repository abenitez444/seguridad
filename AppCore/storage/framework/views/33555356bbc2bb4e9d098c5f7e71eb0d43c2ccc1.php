	...
	<section class="content container-fluid">
		...
		<div class="box box-info">
			...
			<div class="box-header">
				...
				<ul class="pagination pagination-sm no-margin pull-right" v-if="comments.length > 0">
					<li>
			...
			<div class="box-footer clearfix" v-if="pagination.last_page > 0" v-if="comments.length > 0">
										...
										<div class="col-12 col-sm-6 col-md-6 col-lg-6">
											...
											<div class="form-group">	
												<select class="form-control" v-model="comment.status" name="status" style="width: 100%;">
													...
													<option value="pending_review">Pendiente por revisión</option>
												</select>
											</div>
										</div>
									</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/blog/comments.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/keywood/AppGestorContenido/resources/views/admin/blog/comments.blade.php ENDPATH**/ ?>