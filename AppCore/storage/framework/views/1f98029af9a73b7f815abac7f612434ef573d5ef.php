<?php $__env->startSection('title'); ?>Editar artículo <?php $__env->stopSection(); ?>
				...
				<div class="box-body">
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-4 col-lg-4">
									...
									<div class="form-group">
										...
										{{ costs_prices.percentage_financial_costs }}
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-4 col-lg-4">
									...
									<div class="form-group">
										...
										{{ costs_prices.value_financial_costs }}
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-4 col-lg-4">
									...
									<div class="form-group">
										...
										{{ costs_prices.percentage_utility }}
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-4 col-lg-4">
					...
					<div class="row">
						<div class="col-12 col-md-12 pl-30 pr-30">
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-12" id="main_image">
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/shop/articles.edit.js')); ?>"></script>
<script type="text/javascript">
	$(document).ready(function(){
		component.setArticle("<?php echo e($id); ?>")
	});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/AppGestor/AppGestorContenido/resources/views/admin/shop/articles/edit.blade.php ENDPATH**/ ?>