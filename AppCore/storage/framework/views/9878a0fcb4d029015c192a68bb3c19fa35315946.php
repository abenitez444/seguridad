<?php $__env->startSection('title'); ?>Reportes de Calidad del Aire <?php $__env->stopSection(); ?>
...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Reportes de Calidad del Aire </h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Geocalización</a></li>
					<li class="breadcrumb-item active">Reportes de Calidad del Aire</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
					...
					<div class="card-body table-responsive p-0">
						<div class="row mb-3 mt-3">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center">
								<img src="<?php echo e(asset('img/tabla_ica2.png')); ?>" class="img-fluid mb-2" alt="ICG Tabla Calidad de Aire"/>
							</div>
						</div>
						<datatable :columns="columns" :data="rows" :filter-by="filter" class="table table-bordered table-striped">
							<template scope="{ row }" v-if="rows.length > 0">
								<tr>
									...
									<td>{{ row.pressures }}</td>
									<td>{{ row.rainfall }}</td>
									<td :style="'color:#000000; font-weight: 700; background:' +colorICA(row.quality_index)+ ';' ">{{ row.quality_index }}</td>
								</tr>
							</template>
						</datatable>
					</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/reports/airQuality.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/icg/AppCore/resources/views/admin/reports/airQuality.blade.php ENDPATH**/ ?>