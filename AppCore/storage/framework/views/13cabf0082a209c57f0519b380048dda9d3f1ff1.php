<?php $__env->startSection('title'); ?>Reportes de Meteorología <?php $__env->stopSection(); ?>

<?php $__env->startPush('css'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('AppResources/plugins/select2/dist/css/select2.min.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('AppResources/plugins/ekko-lightbox/ekko-lightbox.css')); ?>">
<style type="text/css">
	thead th {
		font-size: 14px;
	}
...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Reportes de Meteorología </h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Geocalización</a></li>
					<li class="breadcrumb-item active">Reportes de Meteorología</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
					...
					<div class="card-body" v-if="typeGraphics == 1">
						...
						<div class="row mt-3 mb-3">
							<div class="col-12 col-md-12 col-lg-12" >
								<h3 class="mb-3 text-center" style="font-weight: 700;color: #666666;">Rosas de Vientos</h3>
							</div>
							<div class="col-6 col-sm-6 col-md-3 col-lg-3" v-if="station.windRoses.length > 0" v-for="windRose in station.windRoses">
								<a :href="'<?php echo e(asset('storage')); ?>/' + windRose.image" data-toggle="lightbox" :data-title="windRose.date" data-gallery="gallery">
									<img :src="'<?php echo e(asset('storage')); ?>/' + windRose.image" class="img-fluid mb-2" :alt="windRose.date"/>
								</a>
							</div>
						</div>
					</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/plugins/ekko-lightbox/ekko-lightbox.min.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/reports/meteorology.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/icg/AppCore/resources/views/admin/reports/meteorology.blade.php ENDPATH**/ ?>