                            ...
                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" class="form-control" placeholder="Ingrese el nombre del usuario" name="name" v-model="user.name">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" class="form-control" placeholder="Ingrese el apellido del usuario" name="last_name" v-model="user.last_name">
                                                            <div class="form-control-position">
                                                                <i class="fa fa-header"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" class="form-control" placeholder="Ingrese la cédula de identidad del usuario" name="dni" v-model="user.dni" data-height="400">
                                                            <div class="form-control-position">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="email" class="form-control" placeholder="Correo Electónico del usuario" name="email" v-model="user.email">
                                                            <div class="form-control-position">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Celular *</label>
                                        <div class="position-relative has-icon-left">
                                            <input type="text" class="form-control" placeholder="Ingrese el número de celular del usuario" name="cellular" v-model="user.cellular">
                                            <div class="form-control-position">
                                                <i class="fa fa-phone"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Ciudad *</label>
                                        <div class="position-relative has-icon-left">
                                            <input type="text" class="form-control" placeholder="Ingrese la ciudad del usuario" name="city" v-model="user.city">
                                            <div class="form-control-position">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Barrio *</label>
                                        <div class="position-relative has-icon-left">
                                            <input type="text" class="form-control" placeholder="Ingrese el barrio del usuario" name="neighborhood" v-model="user.neighborhood">
                                            <div class="form-control-position">
                                                <i class="feather icon-map-pin"></i>
                                            </div>
                                        </div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/users/customers.js')); ?>"></script> 
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Cabpserito/AppCore/resources/views/admin/users/customers.blade.php ENDPATH**/ ?>