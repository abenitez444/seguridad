						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="form-group">	
										<input type="date" class="form-control" name="date_post" v-model="date_post">
									</div>
								</div>
							</div>
							<div class="row">
...
<?php $__env->startPush('js'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/blog/newPublication.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/blog/publicationCreate.blade.php ENDPATH**/ ?>