<?php $__env->startSection('title'); ?>Turnos <?php $__env->stopSection(); ?>
...
<section class="content" id="app-main">
	...
	<div class="card">
		...
		<div class="card-header">
			...
			<?php if(Auth::user()->is_superadmin || Auth::user()->has_role('create_shifts')): ?>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/shifts.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/programacionlogr/public_html/AppCore/resources/views/admin/shifts.blade.php ENDPATH**/ ?>