...
<head>
  ...
  <!-- APP -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('resourcesApp/css/app.css')); ?>">

  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
<body class="hold-transition login-page" style="background: url(<?php echo e(asset('resourcesApp/images/1.jpg')); ?>)">
...
<script type="text/javascript" src="<?php echo e(asset('resourcesApp/js/admin/login.js')); ?>"></script>
...
<?php /**PATH /media/th3khan/Disco de respaldo/Anthony/trabajos/proyectos laravel/GestorContenido/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>