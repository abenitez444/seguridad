                            ...
                            <div class="row">
                            				...
                            				<div class="row">
				                                ...
				                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
				                                    <div class="form-group">
				                                        ...
				                                        <div class="position-relative has-icon-left">
				                                            <input type="text" class="form-control" placeholder="Ingrese la cédula de identidad del domiciliario" name="dni" v-model="user.dni" data-height="400">
				                                            <div class="form-control-position">
				                                ...
				                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
				                                    <div class="form-group">
				                                        ...
				                                        <div class="position-relative has-icon-left">
				                                            <input type="email" class="form-control" placeholder="Correo Electónico del domiciliario" name="email" v-model="user.email">
				                                            <div class="form-control-position">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" class="form-control" placeholder="Ingrese el número de teléfono del domiciliario" name="phone" v-model="user.phone">
                                                            <div class="form-control-position">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <textarea class="form-control" placeholder="Dirección del domiciliario" name="address" rows="3" v-model="user.address"></textarea>
                                            <div class="form-control-position">
