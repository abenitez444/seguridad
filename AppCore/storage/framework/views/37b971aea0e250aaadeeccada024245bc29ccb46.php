        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                -->
                    ...
                    <li class="<?php echo e(request()->routeIs('concerning') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('concerning')); ?>">
                            <i class="fa  fa-building"></i> 
                            <span>Dr. Fernando Bulla</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('we') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('we')); ?>">
                            <i class="fa fa-users"></i> 
                            <span>Nosotros</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('services') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('services')); ?>">
                            <i class="fa fa-diamond"></i> 
                            <span>Servicios</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('certification') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('certification')); ?>">
                    ...
                    <li class="<?php echo e(request()->routeIs('others') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('others')); ?>">
                            <i class="fa fa-puzzle-piece"></i> 
                            <span>Otros</span>
                        </a>
                    </li>

                    <li class="header">REVISTA DIGITAL</li>
                    ...
                    <li class="<?php echo e(request()->routeIs('infoContact.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('infoContact.index')); ?>">
                            <i class="fa fa-building"></i> 
                    ...
                    <li class="<?php echo e(request()->routeIs('option.whatsapp') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('option.whatsapp')); ?>">
...
</html><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/layouts/admin/main.blade.php ENDPATH**/ ?>