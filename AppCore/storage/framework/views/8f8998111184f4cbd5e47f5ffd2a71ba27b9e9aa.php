	...
	<section class="content container-fluid" >
		...
		<div class="box box-info">
			<div class="box-header">
				...
				<ul class="pagination pagination-sm no-margin pull-right" v-if="emails.length > 0">
					<li>
										...
										<div class="modal-body">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6 col-lg-6">
													...
													<div class="form-group">								
														<input type="text" class="form-control" name="subject" v-model="email.subject"  disabled="disabled">
													</div>
												</div>
											</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/email.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/email.blade.php ENDPATH**/ ?>