									...
									<form role="form" id="form_" onsubmit="return false;"  enctype="multipart/form-data" v-on:submit="saveForm()">
										...
										<div class="modal-body">
												...
												<div class="col-12 col-md-12 pl-30 pr-30">
													...
													<div class="row">
														<div class="col-12 col-sm-12 col-md-12 col-lg-12">
															...
															<div class="form-group">		
																<textarea class="form-control" id="content" name="content" placeholder="Contenido para este elemento" rows="10" v-model="element.content"></textarea>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-12 col-md-6 pl-30 pr-30">
													<div class="row">
														<div class="col-sm-12 col-md-12 col-12" id="image_modal">
															<strong>(*)</strong> <label for="image_modal">Imagen secundaria (Modals, Previews) </label>
															<input type="file" class="dropify" name="image_modal" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg" />
														</div>
													</div>
												</div>
												...
												<div class="col-12 col-md-6 pl-30 pr-30">
													<div class="row">
														<div class="col-sm-12 col-md-12 col-12" id="image_ico">
															<strong>(*)</strong> <label for="image_ico">Icono del servico </label>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/web/elements/services.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/web/services.blade.php ENDPATH**/ ?>