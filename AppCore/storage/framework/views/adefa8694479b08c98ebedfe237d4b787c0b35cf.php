				...
				<div class="row">
					<?php if(isset($logoHeader) && !is_null($logoHeader)): ?>
						<div class="form-group mb-0">
							<div class="col-xs-12 col-sm-6 col-md-6">
								...
								<input type="file" class="dropify" name="logoHeader" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg" data-default-file="<?php echo e($logoHeader->getUrlImage()); ?>" data-show-remove="false" v-on:change="logoChange" />
							</div>
						</div>
					...
					<?php else: ?>
						<div class="form-group mb-0">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<label for="logoHeader">Logo del header o cabecera </label>
								<input type="file" class="dropify" name="logoHeader" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg" v-on:change="logoChange" data-show-remove="false" />
							</div>
						</div>
					...
					<?php if(isset($logoFooter) && !is_null($logoFooter)): ?>
						<div class="form-group">
							<div class="col-xs-12 col-sm-6 col-md-6">
								...
								<input type="file" class="dropify" name="logoFooter" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg" data-default-file="<?php echo e($logoFooter->getUrlImage()); ?>" data-show-remove="false" v-on:change="logoChange" />
							</div>
						</div>
					...
					<?php else: ?>
						<div class="form-group">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<label for="logoFooter">Logo del Footer o pie página </label>
								<input type="file" class="dropify" name="logoFooter" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg"   v-on:change="logoChange" data-show-remove="false" />
							</div>
						</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/th3khan/Disco de respaldo/Anthony/trabajos/proyectos laravel/GestorContenido/resources/views/admin/configuration/logo.blade.php ENDPATH**/ ?>