<?php $__env->startSection('title'); ?>Municipios o pueblos <?php $__env->stopSection(); ?>
...
<div id="component">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Municipios o pueblos </li>
		</ol>
	</section>
				...
				<table id="tableList" class="table table-bordered table-striped">
					...
					<tbody>
						<tr v-for="village in elements">
							...
							<th>
								<template v-if="village.is_active == 1">
							...
							<th class="text-right" style="width: 24%;">
								<button type="button" class="btn btn-warning btn-sm" v-on:click="view(village)"><i class="fa fa-edit"></i></button>
								<button type="button" class="btn btn-danger btn-sm " v-on:click="remove(village)"><i class="fa fa-trash"></i></button>
							</th>
						</tr>
										...
										<div class="col-12 col-sm-12 col-md-6 col-lg-6">
											...
											<div class="form-group">
												<div class="input-group">
													...
													<input type="text" class="form-control" id="name" name="name" placeholder="Nombre de marca" v-model="village.name">
												</div>
											</div>
										</div>
										<div class="col-12 col-sm-12 col-md-6 col-lg-6">
											<strong>(*)</strong> <label for="title">Departamento: </label>
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon"><i class="fa fa-building"></i></span>
													<select class="form-control" name="state_id" v-model="village.state.id">
														<option v-for="citie in state" :value="citie.id">{{ citie.name }}</option>
													</select>
												</div>
											</div>
										</div>
										...
										<div class="col-12 col-sm-12 col-md-12 col-lg-12">
											...
											<div class="form-group">
												<div class="checkbox icheck pl-20" >
													<label>
														<input type="checkbox" name="is_active" value="1" checked="checked" v-model="village.is_active" > Activar
													</label>
												</div>
											</div>
										</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/shop/villages.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/AppGestor/AppGestorContenido/resources/views/admin/shop/villages.blade.php ENDPATH**/ ?>