<?php $__env->startSection('title'); ?>Reportes de Novedades <?php $__env->stopSection(); ?>
...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Reportes de Novedades</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a></li>
					<li class="breadcrumb-item active">Reportes de Novedades</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/reports-news.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/safecloudcom/public_html/app/AppCore/resources/views/admin/reportNews.blade.php ENDPATH**/ ?>