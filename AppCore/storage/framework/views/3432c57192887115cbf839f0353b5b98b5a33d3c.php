									...
									<div class="iconos" style="font-size: 22px;">
										...
										<div id="icos_google">
											...
											<div class="form-group">
												<div class="col-xs-3 col-sm-2 col-md-2">
													<label>
														<input type="radio" name="ico" v-model="social.ico" value="fa fa-google-plus" class="minimal icheck">
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/socialsNetworks.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/configuration/social.blade.php ENDPATH**/ ?>