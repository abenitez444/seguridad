<?php $__env->startSection('title'); ?>Traslado de vigilantes <?php $__env->stopSection(); ?>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <?php if(Auth::user()->is_superadmin || Auth::user()->has_role('create_transfer')): ?>
                        ...
                        <template slot-scope="{ row }">
                            <tr>
                                ...
                                <td class="text-right" style="width: 10%; white-space: nowrap;">
                                    <?php if(Auth::user()->is_superadmin || Auth::user()->has_role('view_transfer')): ?>
                                    ...
                                    <?php endif; ?>
                                     <?php if(Auth::user()->is_superadmin || Auth::user()->has_role('delete_transfer')): ?>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/transfer.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/programacionlogr/public_html/AppCore/resources/views/admin/transfer.blade.php ENDPATH**/ ?>