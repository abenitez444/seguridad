...
<div class="container" id="content">
	...
	<div class="row">
		<div class="col-md-12 text-center mt-3">
			<h2 class="tc-verde mb-0"><span class="bg-rosado">PARA QUE</span></h2>
			<h2 class="tc-verde"><span class="bg-rosado">ARMES TU {{ category.name }}</span></h2>
	...
	<div class="row mb-5">
		<div class="col-md-4" v-for="article in articles">
			<div class="card mt-3 l-10" style="width: 80%;">
			  <img class="card-img-top" v-if="article.main_image != null && article.main_image != '' " :src="'<?php echo e(asset('storage/')); ?>/' + article.main_image" alt="article.name">
...
<script type="text/javascript" src="<?php echo e(asset('js/articleByCategoryName.js')); ?>"></script>
<script type="text/javascript">
	$(document).ready(function(){
		var slug_category = "<?php echo e($slug_category); ?>";
		componetArticlesByCategory.getActivatedArticleByCategorySlug(slug_category);
	});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.website.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/keywood/AppGestorContenido/resources/views/website/shop/articleByCategoryName.blade.php ENDPATH**/ ?>