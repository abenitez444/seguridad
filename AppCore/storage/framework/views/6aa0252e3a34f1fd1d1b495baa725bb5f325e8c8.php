				...
				<div class="row">
					<div class="col-xs-12">
						<h2 class="page-header">
							<a class="navbar-brand ml-5" href="<?php echo e(route('website.index')); ?>"><img src="<?php echo e(asset('img/logo.png')); ?>" alt="" width="100"></a> KEY WOOD.
						</h2>
					</div>
					<!-- /.col -->
				</div>
...
<script type="text/javascript" src="<?php echo e(asset('js/thanks.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.website.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/keywood/AppGestorContenido/resources/views/website/shop/thanks.blade.php ENDPATH**/ ?>