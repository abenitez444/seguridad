										...
										<div class="modal-body">
											...
											<div class="row" id="gallery">
												<div class="col-sm-12 col-md-12 col-12">
													<label for="main_image">Imagenes de la galeria </label>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/web/elements/we.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/web/we.blade.php ENDPATH**/ ?>