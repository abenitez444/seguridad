<?php $__env->startSection('title'); ?>Otros elementos <?php $__env->stopSection(); ?>
...
<div id="component">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Otros elementos web </li>
		</ol>
	</section>
														...
														<div class="col-8 col-sm-8 col-md-6 col-lg-6">
															...
															<div class="form-group">
																<div class="input-group">
																	...
																	<input type="text" class="form-control" name="name" placeholder="Nombre del elemento" v-model="element.name">
																</div>
															</div>
														</div>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/web/elements/others.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/web/others.blade.php ENDPATH**/ ?>