<?php $__env->startSection('title'); ?>Editar publicación <?php $__env->stopSection(); ?>
...
<div id="component">
	...
	<section class="content-header">
		<h1>
			Publicacion
			<small> editar {{ publication.title }}</small>
		</h1>
		<ol class="breadcrumb">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Titulo de la publicación" name="title" v-model="publication.title">
									</div>
									<input type="hidden" name="publication_id" value="<?php echo e($id); ?>" >
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 form-group">
									<label for="content">Contenido: </label>
									<textarea id="content" name="content" v-model="publication.content"></textarea>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="form-group">	
										<select class="form-control" v-model="publication.author" name="author" style="width: 100%;">
											<option v-for="author in authors" :value="author.id" :selected="author == publication.author">{{ author.name }}</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="box-body">
							<div class="row">
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="form-group">	
										<select class="form-control" v-model="publication.visibility" name="visibility" style="width: 100%;">
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									<strong>(*)</strong> <label for="date_post">Fecha: </label>
									<div class="form-group">	
										<input type="date" class="form-control" name="date_post" v-model="publication.date_post">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-12 col-sm-7 col-md-7 col-lg-7">
									<div class="form-group">
										<div class="checkbox icheck pl-20">
											<label>
												<input type="checkbox" name="allow_comments" value="1" checked="checked" v-model="publication.allow_comments"> Permitir comentarios
											</label>
										</div>
									</div>
								</div>
								<div class="col-12 col-sm-5 col-md-5 col-lg-5">
									<div class="form-group">
										<div class="checkbox icheck pl-20">
											<label>
												<input type="checkbox" name="is_active" value="1" checked="checked" v-model="publication.is_active"> Activar
											</label>
										</div>
									</div>
								</div>								
						...
						<div class="box-footer clearfix">
									...
									<div id="container-categories" v-if="categories.length > 0">
										<ul>
											<li v-for="category in categories">
												<label>
													<input type="checkbox" name="category[]" :value="category.id" v-model="publication.categories" > {{ category.name }}
												</label>
											</li>
										</ul>
									</div>
							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-12 col-12">
									<div class="callout callout-info text-left">
										<label>
											Se recomienda que las imagenes sean de las mismas dimensiones.<br>
											El tamaño recomendado es de 1920 x 1000
										</label>
									</div>
								</div>								
							</div>
...
<?php $__env->startPush('js'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/blog/editPublication.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/drbulla/AppGestorContenido/resources/views/admin/blog/publicationEdit.blade.php ENDPATH**/ ?>