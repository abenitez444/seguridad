					...
					<div class="row">
						<div class="col-12 col-md-12 pl-30 pr-30">
							...
							<div class="row">
								...
								<div class="col-12 col-sm-12 col-md-4 col-lg-4">
									<strong>(*)</strong> <label for="net_price">Precio Anterior (con IVA): </label>
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-addon"><b>{{ currency.symbol }}</b></span>
											<money type="text" class="form-control" name="previous_price" placeholder="
											Precio neto del artículo o producto" v-model="costs_prices.previous_price" v-bind="money"></money>
										</div>
									</div>
								</div>
							</div>								
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/woman/AppGestorContenido/resources/views/admin/shop/articles/edit.blade.php ENDPATH**/ ?>