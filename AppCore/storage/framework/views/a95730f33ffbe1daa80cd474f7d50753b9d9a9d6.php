									...
									<div class="form-group">
										<div class="input-group">
											...
											<select class="form-control" name="shop_subCategories_id" placeholder="Seleccione una sub-categoría" v-model="article.subCategory.id">
												...
												<option v-if="subCategories.length <= 0" value="">Sin sub-categorías disponibles en la categoría seleccionada</option>
											</select>
										</div>
									</div>
								</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/woman/AppGestorContenido/resources/views/admin/shop/articles/create.blade.php ENDPATH**/ ?>