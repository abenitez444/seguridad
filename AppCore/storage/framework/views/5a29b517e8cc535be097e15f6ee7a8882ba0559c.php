...
<section class="content container-fluid" >
	...
	<div class="box box-info">
		<div class="box-header">
			...
			<ul class="pagination pagination-sm no-margin pull-right" v-if="subscribers.length > 0">
				<li>
...
<script type="text/javascript" src="<?php echo e(asset('AppResources/js/admin/subscriber.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/keywood/AppGestorContenido/resources/views/admin/subscriber.blade.php ENDPATH**/ ?>